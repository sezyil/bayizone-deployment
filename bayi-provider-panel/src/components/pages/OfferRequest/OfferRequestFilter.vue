        ...
        <div class="card-body">
            <div class="row mb-1">
                <div class="col-md-4">
                    ...
                    <label for="dateFilterType">{{ t('common.filter.dateType') }}</label>
                    <select class="form-control" id="dateFilterType" v-model="filter.dateFilterType">
                        <option value="">{{ t('actions.select') }}</option>
                        <option value="offer_create_date">{{ t('common.filter.createDate') }}</option>
                        <option value="offer_due_date">{{ t('components.offers.due_date') }}</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <label for="offer_create_date">{{ t('common.filter.dateStart') }}</label>
