...
import {
    IOfferFormLine,
    IOfferFormLineErrors,
    IOfferFormProduct,
} from "/@src/shared/form/interface-offer";
...
const props = defineProps({
    lineData: {
        type: Object as PropType<IOfferFormLine>,
        required: true,
    },
    errors: {
        type: Object as PropType<IOfferFormLineErrors>,
        required: true,
    },
    productData: {
        type: Array as PropType<IOfferFormProduct[]>,
        required: true,
    },
    colorList: {
...
const isInternational = computed(() => {
    return store.offerForm.detail.is_international;
});
