...
viewWrapper.setPageTitle('Müşteri Siparişleri');
...
const swalCreatePopup = async () => {
    ...
    swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            router.push(`/app/customer_orders/create?customer_id=${selectedCustomerId}`);
        }
    });
}
...
<template>
    <PageContent>
        ...
        <COrderIndex
            v-if="wizardStatus.companyInfo && wizardStatus.hasImage && permission.view" />
    </PageContent>
</template>
