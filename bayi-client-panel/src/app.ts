...
import '/@src/assets/css/icons/fontawesome/styles.min.css';
import '/@src/assets/css/icons/icomoon/styles.min.css';
import VueSweetalert2 from 'vue-sweetalert2';
import PrimeVueTR from '/@src/utils/primevue_tr.json';
