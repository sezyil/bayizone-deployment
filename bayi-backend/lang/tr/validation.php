...
return [
    ...
    'uploaded'             => ':Attribute sunucuya yüklenemedi.',
    ...
    'attributes'           => [
        ...
        /* Product Page */
        'images'                   => 'resim alanı',
        'data.model'               => 'model kodu',
        'data.price'               => 'fiyat',
        'data.quantity'            => 'stok',
        'data.minimum'             => 'minimum miktar',
        'data.status'              => 'ürün durumu',
        'general.description'      => 'ürün açıklaması',
        'general.name'             => 'ürün adı',
        /* /Product Page */
    ],
    'custom' => [
        /* Product Page */
        'images' => [
            'min' => 'Ürüne en az :min fotoğraf tanıtılmalıdır'
        ],
        'images.*.image' => [
            'required' => 'Boş resim değeri mevcut lütfen boş resmi siliniz sıra no :index'
        ],
        'unit_id'=>[
            'required' => 'Birim Türü alanı boş bırakılamaz.',
            'integer' => 'Birim Türü alanı tamsayı tipinde olmalıdır.',
            'exists' => 'Birim Türü alanı geçerli bir birim olmalıdır.',
        ],
        /* /Product Page */
        'country_id' => [
            'required' => 'Ülke alanı boş bırakılamaz.',
            'integer' => 'Ülke alanı tamsayı tipinde olmalıdır.',
            'exists' => 'Ülke alanı geçerli bir ülke olmalıdır.',
        ],
        'state_id' => [
            'required' => 'İl alanı boş bırakılamaz.',
            'integer' => 'İl alanı tamsayı tipinde olmalıdır.',
            'exists' => 'İl alanı geçerli bir il olmalıdır.',
        ],
        'city_id' => [
            'required' => 'İlçe alanı boş bırakılamaz.',
            'integer' => 'İlçe alanı tamsayı tipinde olmalıdır.',
            'exists' => 'İlçe alanı geçerli bir ilçe olmalıdır.',
        ],
        'tax_identity_no' => [
            'required'  => 'Vergi kimlik no alanı boş bırakılamaz.',
            'string'    => 'Vergi kimlik no alanı metin tipinde olmalıdır.',
            'max'    => 'Vergi kimlik no alanı en fazla 11 karakter olmalıdır.',
            'unique' => 'Vergi kimlik no daha önce kayıt edilmiş.',
        ],
    ],
];
