...
class OfferExport implements FromView, ShouldAutoSize, WithDrawings, WithDefaultStyles, WithStyles
{
    protected CustomerOffer $offer;
    protected string $lang;
    /**
     * @return \Illuminate\Support\Collection
     */
    public function __construct(CustomerOffer $offer, $lang)
    {
        $this->offer = $offer;
        $this->lang = $lang;
    }
    ...
    public function view(): View
    {
        ...
        $offer = $this->offer;
        return view('export.excel.customeroffer.export-main', [
            'logo' => $offer->customer->image,
            'data' => $offer,
        ]);
    }
    ...
    public function drawings()
    {
        ...
        $drawing->setPath(public_path($offer->customer->image));
