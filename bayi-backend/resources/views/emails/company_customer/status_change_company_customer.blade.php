                ...
                <td class="v-container-padding-padding"
                    ...
                    <div class="v-text-align v-font-size"
                        ...
                        <p style="line-height: 140%;"><span style="line-height: 19.6px;">
                                @lang('email/company-customer/order-status-changed.body', ['number' => $order->order_no])
                                <br />
                                @lang('common.date'): {{ \Carbon\Carbon::parse($order->order_date)->format('d.m.Y') }}
                                <br />
                                @lang('common.status'): {{ $order->histories->last()->getStatusText() }}
                                @if ($note)
                                    <br />
