                ...
                <td class="v-container-padding-padding"
                    ...
                    <div class="v-text-align v-font-size"
                        ...
                        <p style="line-height: 140%;">
                            <span style="line-height: 19.6px;">Merhaba,</span>
                        </p>
                        <p style="line-height: 140%;"><span style="line-height: 19.6px;">
                                Teklif No: {{ $offer->offer_no }}
                                <br />
                                Müşteri teklifin durumunu değiştirdi. Detaylar aşağıdaki gibidir.
                                <br />
                                Güncellenme Tarihi: {{ \Carbon\Carbon::parse($offer->updated_at)->format('d.m.Y') }}
                                <br />
                                Durum: {{ $status }}
                            </span></p>
