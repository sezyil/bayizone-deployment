...
@section('title', 'Bayizone Hesabınız Oluşturuldu')
@section('content')
                ...
                <td class="v-container-padding-padding"
                    ...
                    <div class="v-text-align v-font-size"
                        ...
                        <p style="line-height: 140%;"><span style="line-height: 19.6px;">
                                Bayizone hesabınız oluşturuldu.<br>Hesabınızı aktifleştirmek için aşağıdaki butona
                                tıklayınız.</span>
                            </span></p>
...
@endsection
@section('button')
    <x-mail.button :uri="$uri" text="Hesabımı Etkinleştir" />
@endsection
